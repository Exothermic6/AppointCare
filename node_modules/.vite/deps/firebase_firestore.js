...
var __PRIVATE_SimpleDb = class ___PRIVATE_SimpleDb {
  ...
  constructor(e, t, n) {
    ...
    12.2 === ___PRIVATE_SimpleDb.D(getUA()) && __PRIVATE_logError("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  ...
  static v() {
    ...
    if (___PRIVATE_SimpleDb.C())
      return true;
    const e = getUA(), t = ___PRIVATE_SimpleDb.D(e), n = 0 < t && t < 10, r2 = ___PRIVATE_SimpleDb.F(e), i = 0 < r2 && r2 < 4.5;
  ...
  async runTransaction(e, t, n, r2) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        const t2 = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s2 = r2(t2).next((e2) => (t2.p(), e2)).catch((e2) => (
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  let i;
  i = __PRIVATE_targetIsDocumentTarget(t.target) ? __PRIVATE_toDocumentsTarget(e.ct, t.target) : __PRIVATE_toQueryTarget(e.ct, t.target);
  ...
  Ot(e) {
    for (const t of e) {
      ...
      if (e2 < 128)
        ...
        this.vt(960 | e2 >>> 6), this.vt(128 | 63 & e2);
      else if (t < "\uD800" || "\uDBFF" < t)
        this.vt(480 | e2 >>> 12), this.vt(128 | 63 & e2 >>> 6), this.vt(128 | 63 & e2);
      else {
...
var __PRIVATE_TargetIndexMatcher = class {
  constructor(e) {
    this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.Yt = e.orderBy, this.Zt = [];
    for (const t of e.filters) {
      const e2 = t;
      e2.isInequality() ? this.Xt = e2 : this.Zt.push(e2);
    }
  }
  /**
  ...
  en(e) {
    ...
    if (i === n.length)
      return true;
    if (void 0 !== this.Xt) {
      if (!r2.has(this.Xt.field.canonicalString())) {
        const e2 = n[i];
        if (!this.nn(this.Xt, e2) || !this.rn(this.Yt[s++], e2))
          return false;
      }
      ++i;
    }
...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
     ...
     */
    this._n = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  /**
  ...
  getDocumentsMatchingTarget(e, t) {
    ...
    return PersistencePromise.forEach(this.an(t), (t2) => this.un(e, t2).next((e2) => {
      ...
      if (r2) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r4);
          }(s, i2), c = this.cn(i2, s, a), l2 = this.cn(i2, s, u), h = this.ln(i2, s, _), P2 = this.hn(i2.indexId, o, c, a.inclusive, l2, u.inclusive, h);
  ...
  hn(e, t, n, r2, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Pn(t[c / a]) : Ee, l2 = this.In(e, _2, n[c % a], r2), h = this.Tn(e, _2, i[c % a], s), P2 = o.map((t2) => this.In(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  getIndexType(e, t) {
    let n = 2;
    const r2 = this.an(t);
    return PersistencePromise.forEach(r2, (t2) => this.un(e, t2).next((e2) => {
  ...
  ln(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r2)
        if (this.An(t, s.fieldPath) && isArray(e2))
          r2 = this.Rn(r2, s, e2);
        else {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.mn(e).next((e2) => r2.G("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.user, e2, n)))));
  }
  updateIndexEntries(e, t) {
    const n = /* @__PURE__ */ new Map();
    return PersistencePromise.forEach(t, (t2, r2) => {
      const i = n.get(t2.collectionGroup);
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, (n2) => this.fn(e, t2, n2).next((t3) => {
        const i3 = this.gn(r2, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.pn(e, r2, n2, t3, i3);
      }))));
    });
  }
  yn(e, t, n, r2) {
  ...
  wn(e, t, n, r2) {
    return __PRIVATE_indexEntriesStore(e).delete([r2.indexId, this.uid, r2.arrayValue, r2.directionalValue, this.dn(n, t.key), t.key.path.toArray()]);
  }
  fn(e, t, n) {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Pn(i2), r2));
    } else
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.an(t), (t2) => this.un(e, t2).next((e2) => e2 || fail())).next(__PRIVATE_getMinOffsetFromFieldIndexes);
  }
};
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  getLastRemoteSnapshotVersion(e) {
    return this.Nn(e).next((e2) => SnapshotVersion.fromTimestamp(new Timestamp(e2.lastRemoteSnapshotVersion.seconds, e2.lastRemoteSnapshotVersion.nanoseconds)));
  }
  getHighestSequenceNumber(e) {
    return this.Nn(e).next((e2) => e2.highestListenSequenceNumber);
  }
  setTargetsMetadata(e, t, n) {
    return this.Nn(e).next((r2) => (r2.highestListenSequenceNumber = t, n && (r2.lastRemoteSnapshotVersion = n.toTimestamp()), t > r2.highestListenSequenceNumber && (r2.highestListenSequenceNumber = t), this.Bn(e, r2)));
  }
  addTargetData(e, t) {
    return this.Ln(e, t).next(() => this.Nn(e).next((n) => (n.targetCount += 1, this.kn(t, n), this.Bn(e, n))));
  }
  updateTargetData(e, t) {
    return this.Ln(e, t);
  }
  removeTargetData(e, t) {
    return this.removeMatchingKeysForTargetId(e, t.targetId).next(() => __PRIVATE_targetsStore(e).delete(t.targetId)).next(() => this.Nn(e)).next((t2) => (__PRIVATE_hardAssert(t2.targetCount > 0), t2.targetCount -= 1, this.Bn(e, t2)));
  }
  /**
  ...
  getTargetCount(e) {
    return this.Nn(e).next((e2) => e2.targetCount);
  }
  getTargetData(e, t) {
...
var __PRIVATE_RollingSequenceNumberBuffer = class {
  constructor(e) {
    this.qn = e, this.buffer = new SortedSet(__PRIVATE_bufferEntryComparator), this.Qn = 0;
  }
  Kn() {
    return ++this.Qn;
  }
...
var __PRIVATE_LruScheduler = class {
  constructor(e, t, n) {
    this.garbageCollector = e, this.asyncQueue = t, this.localStore = n, this.Un = null;
  }
  start() {
    -1 !== this.garbageCollector.params.cacheSizeCollectionThreshold && this.Wn(6e4);
  }
  stop() {
  ...
  Wn(e) {
    __PRIVATE_logDebug("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Un = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
      this.Un = null;
      try {
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  calculateTargetCount(e, t) {
    return this.Gn.zn(e).next((e2) => Math.floor(t / 100 * e2));
  }
  nthSequenceNumber(e, t) {
    if (0 === t)
      return PersistencePromise.resolve(__PRIVATE_ListenSequence.ae);
    const n = new __PRIVATE_RollingSequenceNumberBuffer(t);
    return this.Gn.forEachTarget(e, (e2) => n.$n(e2.sequenceNumber)).next(() => this.Gn.jn(e, (e2) => n.$n(e2))).next(() => n.maxValue);
  }
  removeTargets(e, t, n) {
...
var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
   ...
   */
  updateMetadata(e, t) {
    return this.getMetadata(e).next((n) => (n.byteSize += t, this.Xn(e, n)));
  }
  getEntry(e, t) {
  ...
  getEntries(e, t) {
    ...
    return this.nr(e, t, (e2, t2) => {
      const r2 = this.er(e2, t2);
      n = n.insert(e2, r2);
    }).next(() => n);
  }
  /**
  ...
  getDocumentsMatchingQuery(e, t, n, r2) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).G(IDBKeyRange.bound(s, o, true)).next((e2) => {
      ...
      for (const i2 of e2) {
        const e3 = this.er(DocumentKey.fromSegments(i2.prefixPath.concat(i2.collectionGroup, i2.documentId)), i2);
  ...
  getAllFromCollectionGroup(e, t, n, r2) {
    ...
    return __PRIVATE_remoteDocumentsStore(e).Z({
      ...
      const s2 = this.er(DocumentKey.fromSegments(t2.prefixPath.concat(t2.collectionGroup, t2.documentId)), t2);
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
   ...
   */
  constructor(e, t) {
    super(), this.sr = e, this.trackRemovals = t, // A map of document sizes and read times prior to applying the changes in
    // this buffer.
    this._r = new ObjectMap((e2) => e2.toString(), (e2, t2) => e2.isEqual(t2));
  }
  applyChanges(e) {
    const t = [];
    ...
    return this.changes.forEach((i, s) => {
      ...
      if (t.push(this.sr.removeEntry(e, i, o.readTime)), s.isValidDocument()) {
        const _ = __PRIVATE_toDbRemoteDocument(this.sr.serializer, s);
        r2 = r2.add(i.path.popLast());
        const a = __PRIVATE_dbDocumentSize(_);
        n += a - o.size, t.push(this.sr.addEntry(e, i, _));
      } else if (n -= o.size, this.trackRemovals) {
        const n2 = __PRIVATE_toDbRemoteDocument(this.sr.serializer, s.convertToNoDocument(SnapshotVersion.min()));
        t.push(this.sr.addEntry(e, i, n2));
      }
    }), r2.forEach((n2) => {
      t.push(this.sr.indexManager.addToCollectionParentIndex(e, n2));
    }), t.push(this.sr.updateMetadata(e, n)), PersistencePromise.waitFor(t);
  }
  getFromCache(e, t) {
    return this.sr.tr(e, t).next((e2) => (this._r.set(t, {
      size: e2.size,
      readTime: e2.document.readTime
    }), e2.document));
  }
  getAllFromCache(e, t) {
    return this.sr.rr(e, t).next(({ documents: e2, ir: t2 }) => (
...
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  constructor(e, t) {
    this.persistence = e, this.Jr = new ObjectMap((e2) => __PRIVATE_encodeResourcePath(e2.path), (e2, t2) => e2.isEqual(t2)), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
  }
  static zr(e, t) {
  ...
  jn(e, t) {
    return PersistencePromise.forEach(this.Jr, (n, r2) => this.Zn(e, n, r2).next((e2) => e2 ? PersistencePromise.resolve() : t(r2)));
  }
  removeTargets(e, t, n) {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    return r2.vr(e, (r3) => this.Zn(e, r3, t).next((e2) => {
      e2 || (n++, i.removeEntry(r3, SnapshotVersion.min()));
    })).next(() => i.apply(e)).next(() => n);
  }
  markPotentiallyOrphaned(e, t) {
    return this.Jr.set(t, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return this.Jr.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  removeReference(e, t, n) {
    return this.Jr.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  ...
  Zn(e, t, n) {
    return PersistencePromise.or([() => this.persistence.Ur(e, t), () => this.persistence.getTargetCache().containsKey(e, t), () => {
      const e2 = this.Jr.get(t);
...
var __PRIVATE_SchemaConverter = class {
  ...
  B(e, t, n, r2) {
    ...
    })), n < 5 && r2 >= 5 && (s = s.next(() => this.Yr(i))), n < 6 && r2 >= 6 && (s = s.next(() => (function __PRIVATE_createDocumentGlobalStore(e2) {
      e2.createObjectStore("remoteDocumentGlobal");
    }(e), this.Zr(i)))), n < 7 && r2 >= 7 && (s = s.next(() => this.Xr(i))), n < 8 && r2 >= 8 && (s = s.next(() => this.ei(e, i))), n < 9 && r2 >= 9 && (s = s.next(() => {
    ...
    })), n < 10 && r2 >= 10 && (s = s.next(() => this.ti(i))), n < 11 && r2 >= 11 && (s = s.next(() => {
    ...
    }(e)).next(() => this.ni(e, i)).next(() => e.deleteObjectStore("remoteDocuments"))), n < 14 && r2 >= 14 && (s = s.next(() => this.ri(e, i))), n < 15 && r2 >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
  ...
  ri(e, t) {
    const n = t.store("mutations"), r2 = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.zr, this.serializer.ct);
    return n.G().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.ii = i, this.window = s, this.document = o, this.si = a, this.oi = u, this._i = c, this.Br = null, this.Lr = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    this.ai = null, this.inForeground = false, /** Our 'visibilitychange' listener if registered. */
    this.ui = null, /** The client metadata refresh task. */
    this.ci = null, /** The last time we garbage collected the client metadata object store. */
    this.li = Number.NEGATIVE_INFINITY, /** A listener to notify on primary state changes. */
    this.hi = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
    ...
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r2), this.Pi = t + "main", this.serializer = new __PRIVATE_LocalSerializer(_), this.Ii = new __PRIVATE_SimpleDb(this.Pi, this._i, new __PRIVATE_SchemaConverter(this.serializer)), this.kr = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.Qr = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ti = this.window.localStorage : (this.Ti = null, false === u && __PRIVATE_logError("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  start() {
    return this.Ei().then(() => {
      ...
      return this.di(), this.Ai(), this.Ri(), this.runTransaction("getHighestListenSequenceNumber", "readonly", (e) => this.kr.getHighestSequenceNumber(e));
    }).then((e) => {
      this.Br = new __PRIVATE_ListenSequence(e, this.si);
    }).then(() => {
      this.Lr = true;
  ...
  Ei() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary)
        return this.mi(e).next((e2) => {
          e2 || (this.isPrimary = false, this.ii.enqueueRetryable(() => this.hi(false)));
        });
    }).next(() => this.fi(e)).next((t) => this.isPrimary && !t ? this.gi(e).next(() => false) : !!t && this.pi(e).next(() => true))).catch((e) => {
      ...
      this.isPrimary !== e && this.ii.enqueueRetryable(() => this.hi(e)), this.isPrimary = e;
    });
  }
  mi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => PersistencePromise.resolve(this.yi(e2)));
  }
  wi(e) {
  ...
  async Si() {
    if (this.isPrimary && !this.bi(this.li, 18e5)) {
      ...
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (e2) => {
        ...
        return t.G().next((e3) => {
          const n = this.Di(e3, 18e5), r2 = e3.filter((e4) => -1 === n.indexOf(e4));
          return PersistencePromise.forEach(r2, (e4) => t.delete(e4.clientId)).next(() => r2);
        });
      }).catch(() => []);
      if (this.Ti)
        for (const t of e)
          this.Ti.removeItem(this.vi(t.clientId));
    }
  }
  /**
   ...
   */
  Ri() {
    this.ci = this.ii.enqueueAfterDelay("client_metadata_refresh", 4e3, () => this.Ei().then(() => this.Si()).then(() => this.Ri()));
  }
   ...
   */
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      if (null !== t && this.bi(t.leaseTimestampMs, 5e3) && !this.Ci(t.ownerId)) {
        if (this.yi(t) && this.networkEnabled)
          return true;
        if (!this.yi(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).G().next((e2) => void 0 === this.Di(e2, 5e3).find((e3) => {
  ...
  async shutdown() {
    this.Lr = false, this.Fi(), this.ci && (this.ci.cancel(), this.ci = null), this.Mi(), this.xi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
    // has obtained the primary lease.
    await this.Ii.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
   ...
   */
  Di(e, t) {
    return e.filter((e2) => this.bi(e2.updateTimeMs, t) && !this.Ci(e2.clientId));
  }
  /**
   ...
   */
  Ni() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).G().next((e2) => this.Di(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.Lr;
  }
  ...
  runTransaction(e, t, n) {
    ...
    let s;
    return this.Ii.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.Br ? this.Br.next() : __PRIVATE_ListenSequence.ae), "readwrite-primary" === t ? this.mi(s).next((e2) => !!e2 || this.fi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.ii.enqueueRetryable(() => this.hi(false)), new FirestoreError(v2.FAILED_PRECONDITION, F2);
      return n(s);
    }).next((e2) => this.pi(s).next(() => e2)) : this.Bi(s).next(() => n(s)))).then((e2) => (s.raiseOnCommittedEvent(), e2));
  }
  /**
  ...
  Bi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.bi(e2.leaseTimestampMs, 5e3) && !this.Ci(e2.ownerId) && !this.yi(e2) && !(this.oi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(v2.FAILED_PRECONDITION, Ae);
    });
  }
  /**
  ...
  gi(e) {
    ...
    return t.get("owner").next((e2) => this.yi(e2) ? (__PRIVATE_logDebug("IndexedDbPersistence", "Releasing primary lease."), t.delete("owner")) : PersistencePromise.resolve());
  }
  ...
  di() {
    null !== this.document && "function" == typeof this.document.addEventListener && (this.ui = () => {
      this.ii.enqueueAndForget(() => (this.inForeground = "visible" === this.document.visibilityState, this.Ei()));
    }, this.document.addEventListener("visibilitychange", this.ui), this.inForeground = "visible" === this.document.visibilityState);
  }
  Mi() {
    this.ui && (this.document.removeEventListener("visibilitychange", this.ui), this.ui = null);
  }
  /**
  ...
  Ci(e) {
    var t;
    try {
      const n = null !== (null === (t = this.Ti) || void 0 === t ? void 0 : t.getItem(this.vi(e)));
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_debugCast(n.kr), i = n.Ji.get(t);
  return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", (e2) => r2.ut(e2, t).next((e3) => e3 ? e3.target : null));
}
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Zi.get(t) || SnapshotVersion.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n.Xi.getAllFromCollectionGroup(
    e2,
    t,
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r2) {
  ...
  for (const e2 of n) {
    const n2 = t.os(e2.metadata.name);
    e2.document && (s = s.add(n2));
    const r3 = t._s(e2);
    r3.setReadTime(t.us(e2.metadata.readTime)), o = o.insert(n2, r3);
  }
  const _ = i.Xi.newChangeBuffer({
    trackRemovals: true
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.kr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.kr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.ns, t2.rs)).next(() => t2.ns)));
}
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r2.snapshotVersion.compareTo(s) >= 0)
      return i.Qr.saveNamedQuery(e2, t);
    const o = r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
    return i.Ji = i.Ji.insert(o.targetId, o), i.kr.updateTargetData(e2, o).next(() => i.kr.removeMatchingKeysForTargetId(e2, r2.targetId)).next(() => i.kr.addMatchingKeys(e2, n, r2.targetId)).next(() => i.Qr.saveNamedQuery(e2, t));
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.ii = t, this.persistenceKey = n, this.Is = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Ts = this.Es.bind(this), this.ds = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.As = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Rs = createWebStorageClientStateKey(this.persistenceKey, this.Is), this.Vs = /** Assembles the key for the current sequence number. */
    function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.ds = this.ds.insert(this.Is, new __PRIVATE_LocalClientState()), this.fs = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.gs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.ps = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.ys = /** Assembles the key for the online state of the primary tab. */
    function createWebStorageOnlineStateKey(e2) {
      return `firestore_online_state_${e2}`;
    }(this.persistenceKey), this.ws = function createBundleLoadedKey(e2) {
  ...
  async start() {
    ...
    for (const t2 of e) {
      ...
      if (e2) {
        const n = __PRIVATE_RemoteClientState.cs(t2, e2);
    ...
    for (const e2 of this.As)
      this.Es(e2);
    this.As = [], // Register a window unload hook to remove the client metadata entry from
  ...
  updateMutationState(e, t, n) {
    this.Cs(e, t, n), // Once a final mutation result is observed by other clients, they no longer
  ...
  addLocalQueryTarget(e) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (n) {
        const r2 = __PRIVATE_QueryTargetMetadata.cs(e, n);
        r2 && (t = r2.state);
      }
    }
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.Ts), this.removeItem(this.Rs), this.started = false);
  }
  getItem(e) {
  ...
  Es(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Rs)
        ...
        if (this.started) {
          if (null !== t.key) {
            if (this.fs.test(t.key)) {
              if (null == t.newValue) {
                const e2 = this.Bs(t.key);
                return this.Ls(e2, null);
              }
              {
                const e2 = this.ks(t.key, t.newValue);
                if (e2)
                  return this.Ls(e2.clientId, e2);
              }
              ...
              const e2 = this.Us(t.newValue);
              await Promise.all(e2.map((e3) => this.syncEngine.Ws(e3)));
            }
          }
        } else
          this.As.push(t);
  ...
  ks(e, t) {
    const n = this.Bs(e);
    return __PRIVATE_RemoteClientState.cs(n, t);
  }
  /**
   ...
   */
  qs(e, t) {
    const n = this.gs.exec(e), r2 = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    return __PRIVATE_MutationMetadata.cs(new User(i), r2, t);
  }
  /**
   ...
   */
  Ks(e, t) {
    const n = this.ps.exec(e), r2 = Number(n[1]);
    return __PRIVATE_QueryTargetMetadata.cs(r2, t);
  }
  /**
   ...
   */
  bs(e) {
    return __PRIVATE_SharedOnlineState.cs(e);
  }
  Us(e) {
    return JSON.parse(e);
  }
  ...
  Ls(e, t) {
    const n = t ? this.ds.insert(e, t) : this.ds.remove(e), r2 = this.vs(this.ds), i = this.vs(n), s = [], o = [];
    return i.forEach((e2) => {
      r2.has(e2) || s.push(e2);
    }), r2.forEach((e2) => {
      i.has(e2) || o.push(e2);
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, I_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    const r3 = __PRIVATE_toQueryTarget(e2, t2), i2 = {}, s2 = [];
    let o2 = 0;
    return n2.forEach((e3) => {
      const t3 = "aggregate_" + o2++;
      i2[t3] = e3.alias, "count" === e3.Ee ? s2.push({
        alias: t3,
        count: {}
      }) : "avg" === e3.Ee ? s2.push({
        alias: t3,
  ...
  }(i.serializer, __PRIVATE_queryToTarget(t), n), _ = s.parent;
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  _s(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.os(e.metadata.name), this.us(e.metadata.readTime));
  }
  us(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.j_ = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
  ...
  H_(e) {
    ...
    if (e.G_.namedQuery)
      this.queries.push(e.G_.namedQuery);
    else if (e.G_.documentMetadata) {
      this.documents.push({
        metadata: e.G_.documentMetadata
      }), e.G_.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.G_.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.G_.document && (this.documents[this.documents.length - 1].document = e.G_.document, ++t);
  ...
  J_(e) {
    ...
    for (const r2 of e)
      if (r2.metadata.queries) {
        const e2 = n.os(r2.metadata.name);
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.j_.id), t = this.J_(this.documents);
    for (const e2 of this.queries)
      await __PRIVATE_localStoreSaveNamedQuery(this.localStore, e2, t.get(e2.name));
    return this.progress.taskState = "Success", {
      progress: this.progress,
      Y_: this.collectionGroups,
      Z_: e
    };
  }
};
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.ca), i;
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r2) {
  const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (e3) => r3.Dn(e3, t2).next((t3) => t3 ? n2.localDocuments.getDocuments(e3, t3) : PersistencePromise.resolve(null)));
  }(i.localStore, t);
  null !== s ? ("pending" === n ? (
    ...
    (__PRIVATE_processUserCallback(i, t, r2 || null), __PRIVATE_triggerPendingWritesCallbacks(i, t), function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(e2, t2) {
      __PRIVATE_debugCast(__PRIVATE_debugCast(e2).mutationQueue).Cn(t2);
    }(i.localStore, t))
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.ya) {
    ...
    n.ya = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2)
      __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.ya) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.ma.Rr(), t3.Va = /* @__PURE__ */ new Map(), t3.Ra = new SortedMap(DocumentKey.comparator);
    }(n), n.ya = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const e3 of n2) {
        const t3 = r2.Ea.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
function __PRIVATE_syncEngineGetActiveClients(e) {
  return function __PRIVATE_localStoreGetActiveClients(e2) {
    return __PRIVATE_debugCast(__PRIVATE_debugCast(e2).persistence).Ni();
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      if (await function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (e4) => n3.Qr.getBundleMetadata(e4, t3.id)).then((e4) => !!e4 && e4.createTime.compareTo(r4) >= 0);
      }(e2.localStore, r3))
      ...
      let s = await t2.ba();
      for (; s; ) {
        const e3 = await i.H_(s);
        e3 && n2._updateProgress(e3), s = await t2.ba();
      }
      ...
      await function __PRIVATE_localStoreSaveBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("Save bundle", "readwrite", (e4) => n3.Qr.saveBundleMetadata(e4, t3));
      }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o.Y_);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Da = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Da.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Da.syncEngine), await __PRIVATE_fillWritePipeline(this.Da.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
    // set it after localStore / remoteStore are started.
    await this.persistence.Vi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Da = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
      Gs: __PRIVATE_syncEngineApplyBatchState.bind(null, t),
      zs: __PRIVATE_syncEngineApplyTargetState.bind(null, t),
      js: __PRIVATE_syncEngineApplyActiveTargetsChange.bind(null, t),
      Ni: __PRIVATE_syncEngineGetActiveClients.bind(null, t),
      Ws: __PRIVATE_syncEngineSynchronizeWithChangedDocuments.bind(null, t)
    }, await this.sharedClientState.start()), // NOTE: This will immediately call the listener, so we make sure to
    // set it after localStore / remoteStore are started.
    await this.persistence.Vi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Da.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Fa = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.Ma = function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    }(), // Read the metadata (which is the first element).
    this.xa().then((e2) => {
      e2 && e2.z_() ? this.metadata.resolve(e2.G_.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.G_)}`));
  ...
  async xa() {
    ...
    if (null === e)
      return null;
    const t = this.Ma.decode(e), n = Number(t);
    isNaN(n) && this.Na(`length string (${t}) is not valid number`);
    const r2 = await this.Ba(n);
  ...
  async Oa() {
    ...
    if (0 === this.buffer.length)
      return null;
    const e = this.La();
    e < 0 && this.Na("Reached the end of bundle when a length string is expected.");
  ...
  async Ba(e) {
    for (; this.buffer.length < e; ) {
      await this.ka() && this.Na("Reached the end of bundle when more is expected.");
    }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.yo("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.qa = n.maxAttempts, this.Ko = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Qa() {
    this.Ko.xo(async () => {
      const e = new Transaction$2(this.datastore), t = this.Ka(e);
      t && t.then((t2) => {
  ...
  $a(e) {
    this.qa > 0 && this.Ua(e) ? (this.qa -= 1, this.asyncQueue.enqueueAndForget(() => (this.Qa(), Promise.resolve()))) : this.deferred.reject(e);
  }
  Ua(e) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r2 = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r2.ss), s = i.sa(r2.documents), o = i.applyChanges(
        s,
        /* updateLimboDocuments= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).O_.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  }(await __PRIVATE_getEventManager(e), n)), () => {
    n.Ca(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).O_.delete(t2);
    }(await __PRIVATE_getEventManager(e), n));
  };
}
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
    ...
    return n.persistence.runTransaction("Get named query", "readonly", (e3) => n.Qr.getNamedQuery(e3, t2));
...
var __PRIVATE_NumericIncrementFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = new __PRIVATE_NumericIncrementTransformOperation(e.serializer, toNumber(e.serializer, this.mu));
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.Ru(r2 ? 4 : 3, t));
}
...
function __PRIVATE_newQueryBoundFromDocOrFields(e, t, n, r2) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1)
    return function __PRIVATE_newQueryBoundFromDocument(e2, t2, n2, r3, i) {
      ...
      const s = [];
      for (const n3 of __PRIVATE_queryOrderBy(e2))
